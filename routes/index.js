...
router.get('/', function(req, res) {
  res.render('index', { title: 'icemagic App', user:req.user });
});

router.get('/register', function(req, res) {
  res.render('register', { title: 'icemagic App Registration'});
  });
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'icemagic App Login', user : req.user });
});
